<template>
  <div class="root">
    <Table :data="data" :columns="columns" :size="size" :height="height" @on-row-click="onRowClick"
      @on-sort-change="onSortChange" @on-row-dblclick="onRowDbClick" @on-selection-change="onSelect"
