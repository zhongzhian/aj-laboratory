  ...
  <div class="manage-layout">
    ...
    <div class="manage-header">
      ...
      <div class="manage-header-right">
        ...
        <div class="manage-header-author green-color">{{courseInfo.teacherName}}</div>
      </div>
    </div>
    <!-- content -->
    <div class="manage-content">
      <div class="manage-content-left">
        <img class="manage-content-img" :src="courseInfo.mainImg" />
        <div class="manage-sider">
          <ul class="manage-sider-ul">
            <li
              ...
              :value="item"
              :key="index"
              :class="{'manage-sider':true,'active':(item.key === key)}"
            >{{item.label}}</li>
        ...
        if (v.name === tname) {
          if (_this.isGuest) {
            data = _.filter(data, d => {
              return (
                d.name != "manage-index-lab" && d.name != "manage-index-exam"
              );
            });
          }
