  ...
  <div class="manage-layout">
    ...
    <div class="manage-header">
      ...
      <div class="manage-header-right">
        <div class="manage-header-title">系统设置</div>
        <div class="manage-header-author green-color">管理员</div>
      </div>
    </div>
    <!-- content -->
    <div class="manage-content">
      <div class="manage-content-left">
        <!-- <img class="manage-content-img" src="static/images/bj.png" /> -->
...
export default {
  ...
  mounted() {
    // console.log("mounted.this.$appMenus", this.appMenus);
